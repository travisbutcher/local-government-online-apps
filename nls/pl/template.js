...
({
        ...
        labels: {
            ...
            title: "ł_title_ą",  // Shown as title hint in print specification box if a title hint is not configured
            author: "ł_author_ą"  // Shown as author hint in print specification box if an author hint is not configured
        },
        prompts: {
        ...
        messages: {
            ...
            allSearchFieldsMissing: "ł_None of these fields was found in the map search layer_ą",  // Appears before a list of fields in the configured map search layer; shown when the app cannot find any of the fields that were configured for the search command; works with the layerFields prompt
            yourContentSubmitted: "ł_Your content has been submitted. Thank you._ą",  // Appears after content has been added to the map and successfully submitted to the server
            noConfiguration: "ł_Unable to access application's configuration_ą",  // Appears if the app, during startup, cannot get access to or find the configuration information; without the information, it cannot build the UI
            unableToLaunchApp: "ł_Unable to launch application_ą"  // Appears for any failure to build the user interface
        }
    })
);
