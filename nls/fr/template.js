...
({
        tooltips: {
            ...
            collect: "æ_Add content to map_Â",  // Command button to open a template picker to add features to the map
            filter: "æ_Filter map layers_Â",  // Explains purpose of type-in box affiliated with template picker
