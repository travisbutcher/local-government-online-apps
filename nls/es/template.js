...
({
        tooltips: {
            ...
            collect: "á_Add content to map_Ó",  // Command button to open a template picker to add features to the map
            filter: "á_Filter map layers_Ó",  // Explains purpose of type-in box affiliated with template picker
