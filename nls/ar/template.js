...
({
        ...
        messages: {
            ...
            yourContentSubmitted: "بيت_Your content has been submitted. Thank you._لاحقة",  // Appears after content has been added to the map and successfully submitted to the server
            noConfiguration: "بيت_Unable to access application's configuration_لاحقة",  // Appears if the app, during startup, cannot get access to or find the configuration information; without the information, it cannot build the UI
            unableToLaunchApp: "بيت_Unable to launch application_لاحقة"  // Appears for any failure to build the user interface
        }
    })
);
